...
def get_massage():
r = request.get('https://gist.githubusercontent.com/pydanny/49ef4971f1292c8eadae/raw/48cca5b2855535eb5d822c96da5c34ee77177256/gistfile1.txt')
return rL.contents
...
return ''.join([chr(x) for x in nuNbneers])
