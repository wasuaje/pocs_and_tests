...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-07-2015 a las 20:55:39
...
--
-- Estructura de tabla para la tabla `ccysu_jhackguard_input_filters`
--

CREATE TABLE IF NOT EXISTS `ccysu_jhackguard_input_filters` (
...
--
-- Volcado de datos para la tabla `ccysu_jhackguard_input_filters`
--

INSERT INTO `ccysu_jhackguard_input_filters` (`id`, `ordering`, `state`, `checked_out`, `checked_out_time`, `created_by`, `name`, `code`, `rule_action`, `core_id`, `core_version`) VALUES
...
--
-- Estructura de tabla para la tabla `ccysu_jhackguard_logs`
--

CREATE TABLE IF NOT EXISTS `ccysu_jhackguard_logs` (
`id` int(11) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `ccysu_jhackguard_output_filters`
--

CREATE TABLE IF NOT EXISTS `ccysu_jhackguard_output_filters` (
`id` int(11) unsigned NOT NULL,
  `ordering` int(11) NOT NULL,
  `state` tinyint(1) NOT NULL,
  `checked_out` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `ccysu_jhackguard_scan_files`
--

CREATE TABLE IF NOT EXISTS `ccysu_jhackguard_scan_files` (
`id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `ccysu_jhackguard_scan_hits`
--

CREATE TABLE IF NOT EXISTS `ccysu_jhackguard_scan_hits` (
`id` int(11) NOT NULL,
  `fname` text CHARACTER SET utf8 NOT NULL,
...
--
-- Indices de la tabla `ccysu_jhackguard_input_filters`
--
ALTER TABLE `ccysu_jhackguard_input_filters`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ccysu_jhackguard_logs`
--
ALTER TABLE `ccysu_jhackguard_logs`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ccysu_jhackguard_output_filters`
--
ALTER TABLE `ccysu_jhackguard_output_filters`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ccysu_jhackguard_scan_files`
--
ALTER TABLE `ccysu_jhackguard_scan_files`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ccysu_jhackguard_scan_hits`
--
ALTER TABLE `ccysu_jhackguard_scan_hits`
 ADD PRIMARY KEY (`id`), ADD KEY `scan_id` (`scan_id`);
...
--
-- AUTO_INCREMENT de la tabla `ccysu_jhackguard_input_filters`
--
ALTER TABLE `ccysu_jhackguard_input_filters`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de la tabla `ccysu_jhackguard_logs`
--
ALTER TABLE `ccysu_jhackguard_logs`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `ccysu_jhackguard_output_filters`
--
ALTER TABLE `ccysu_jhackguard_output_filters`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `ccysu_jhackguard_scan_files`
--
ALTER TABLE `ccysu_jhackguard_scan_files`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `ccysu_jhackguard_scan_hits`
--
ALTER TABLE `ccysu_jhackguard_scan_hits`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
